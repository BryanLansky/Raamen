<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminFolder/admin.Master" AutoEventWireup="true" CodeBehind="InsertRamen.aspx.cs" Inherits="AOLPROJECTPSD.View.AdminFolder.InsertRamen" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="Meat_Textbox" runat="server"></asp:TextBox><br />
